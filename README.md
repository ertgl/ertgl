<details>
  ...
  <p>
    ...
    <small>
      <a
        href="https://youtu.be/h4Bq69HfR0Y"
        target="_blank"
        title="Listen to the song #1"
      >[🎵]</a>
    </small>
    <small>
      <a
        href="https://youtu.be/eth4y7YHfJQ"
        target="_blank"
        title="Listen to the song #2"
      >[🎶]</a>
    </small>
  </p>
  ...
  <p>
    My software development approach is primarily data-centric, balancing both
    holistic and atomistic perspectives.
  </p>
  ...
  <p>
    Some technical topics I'm interested:
  </p>
  ...
  <p>
    Some principles I prefer to uphold:
  </p>

  - **Accessibility**: Emergency calls? Check. The silence for deaf people?
    Also check.
  - **Deterministic environment**: Automated updates on planes? Be ready to
    reboot at 30,000 feet.
  - **Resource consumption**: Performance boasted? How about now it needs its
    own cooling tower?

  <p>
    Some talks I recommend:
  </p>

  - ["The Mess We're In" by Joe Armstrong](https://youtu.be/lKXe3HUG2l4)
  - [OOPSLA Conference: Growing a Language](https://youtu.be/lw6TaiXzHAE)
